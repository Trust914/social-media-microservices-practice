...
export const authMiddleware =  (req,res,next) => {
    ...
    if(!userId){
        const authError = new MediaServiceError("AuthenticationOrAuthorizationError",HTTPCODES.UNAUTHORISED,"User not authorised to proceed. User must login or register to continue",true)
        next(authError)
    }
